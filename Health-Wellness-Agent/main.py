...
with col1:
    ...
    if tool == "Workout Generator":
        fitness_level = st.selectbox("Your level:", ["beginner", "intermediate", "advanced"])
...
with col2:
    ...
    if st.button("Save Entry", key="entry_saved"):
...
# Footer
st.markdown("---")
st.markdown("<p style='text-align: center; color: #666;'>🌱 Nourish your Health, body, and soul</p>", 
            unsafe_allow_html=True)